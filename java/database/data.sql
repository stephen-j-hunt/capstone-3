...
insert into movies (id, title, release_date, poster, overview) values (1, 'Dancer Upstairs, The', '7/14/2022', 'http://dummyimage.com/121x100.png/ff4444/ffffff', 'curae duis faucibus accumsan odio curabitur convallis duis consequat dui nec nisi');
insert into movies (id, title, release_date, poster, overview) values (2, 'Why We Fight', '7/17/2022', 'http://dummyimage.com/190x100.png/dddddd/000000', 'sit amet lobortis sapien sapien non mi integer ac neque duis bibendum morbi non quam');
insert into movies (id, title, release_date, poster, overview) values (3, 'Hairspray', '5/9/2022', 'http://dummyimage.com/243x100.png/cc0000/ffffff', 'ante vel ipsum praesent blandit lacinia erat vestibulum sed magna at nunc commodo placerat praesent blandit nam nulla integer pede');
insert into movies (id, title, release_date, poster, overview) values (4, 'Idiot, The (Hakuchi)', '1/6/2023', 'http://dummyimage.com/124x100.png/5fa2dd/ffffff', 'pede justo eu massa donec dapibus duis at velit eu est congue elementum in hac habitasse platea');
insert into movies (id, title, release_date, poster, overview) values (5, 'Belle époque', '9/5/2022', 'http://dummyimage.com/121x100.png/ff4444/ffffff', 'lorem ipsum dolor sit amet consectetuer adipiscing elit proin risus praesent lectus vestibulum quam sapien');
insert into movies (id, title, release_date, poster, overview) values (6, 'Twilight of a Womans Soul (Sumerki zhenskoi dushi)', '1/19/2023', 'http://dummyimage.com/243x100.png/ff4444/ffffff', 'a libero nam dui proin leo odio porttitor id consequat in consequat ut nulla sed accumsan');
insert into movies (id, title, release_date, poster, overview) values (7, 'Murder Ahoy', '1/30/2023', 'http://dummyimage.com/145x100.png/cc0000/ffffff', 'cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus vivamus vestibulum sagittis sapien cum sociis natoque');
insert into movies (id, title, release_date, poster, overview) values (8, 'Mac and Me', '2/17/2023', 'http://dummyimage.com/154x100.png/cc0000/ffffff', 'augue vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia');
insert into movies (id, title, release_date, poster, overview) values (9, 'Scandal (Shubun)', '12/13/2022', 'http://dummyimage.com/223x100.png/cc0000/ffffff', 'lobortis convallis tortor risus dapibus augue vel accumsan tellus nisi eu orci mauris lacinia sapien quis');
insert into movies (id, title, release_date, poster, overview) values (10, 'Dug''s Special Mission', '10/27/2022', 'http://dummyimage.com/216x100.png/ff4444/ffffff', 'diam cras pellentesque volutpat dui maecenas tristique est et tempus semper est quam pharetra magna');
